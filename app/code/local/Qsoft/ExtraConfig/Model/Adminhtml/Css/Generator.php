<?php
class Qsoft_ExtraConfig_Model_Adminhtml_Css_Generator
{
  ...
  {    
    ...
    foreach($this->_cssFileName as $filename) {             
      $this->_themeSkinCssPath = Mage::getBaseDir()."/skin/frontend/qsoftblind/default/css/override/".$filename.$overridefilename.".css";      
      $updateCss = Mage::getBaseDir('design')."/frontend/qsoftblind/default/template/override/".$filename.".phtml";      
