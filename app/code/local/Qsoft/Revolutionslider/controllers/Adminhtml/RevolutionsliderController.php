...
class Qsoft_Revolutionslider_Adminhtml_RevolutionsliderController extends Mage_Adminhtml_Controller_Action
{
    ...
    {
	return Mage::getSingleton('admin/session')->isAllowed('qsoft');
    }
}